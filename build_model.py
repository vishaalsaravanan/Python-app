...
if __name__ == '__main__':
        ...
        model_error=[]
        add_metric=np.array([])
        # returns model to work on
        '''
                        To Do
            1.Need to connect to firebase
            2.Delete Local Dataset Reference
        '''
        rf=float(input("Enter your risk factor \n"))
        ...
        #FinalMetric contains all the final evaluation scores
        # Final_Metric=add_df.copy()
        #Recommendation        
...
# print(portfolios.head())
        ...
        for i in range(0,val):
            ...
            i+=1
        # print(len(top_opr_copy))
        # print(top_opr_copy.iloc[0,1])
        
        # print(top_opr_copy.columns[1])
        top_opr_copy=top_opr_copy.sort_values(top_opr_copy.columns[1],ascending=False)
        # app.run(host="127.0.0.18",port=8080,debug=True)
